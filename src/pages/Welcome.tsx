      ...
      <header className="bg-therapeutic-lavender/10 backdrop-blur-sm sticky top-0 z-50 w-full border-b border-therapeutic-lavender/20">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-xl font-semibold tracking-tight">ReCognia</h1>
          </div>
          ...
          <div className="container mx-auto px-4 flex flex-col md:flex-row items-center gap-10">
            <div className="md:w-1/2 space-y-6">
              ...
              <p className="text-lg text-therapeutic-charcoal/80">
                ReCognia helps you manage PTSD symptoms, track progress, and develop coping mechanisms through personalized AI-guided therapy sessions.
              </p>
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl font-bold text-center mb-12 text-therapeutic-charcoal">
              How ReCognia Helps Your Recovery
            </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-white p-6 rounded-xl shadow-md">
                ...
                <p className="text-therapeutic-charcoal/80 italic">
                  "ReCognia has been transformative for my PTSD recovery. The personalized therapy and tracking tools have helped me manage my symptoms and regain control of my life."
                </p>
              </div>
              ...
              <div className="bg-white p-6 rounded-xl shadow-md">
                ...
                <p className="text-therapeutic-charcoal/80 italic">
                  "After my car accident, I struggled with severe PTSD. ReCognia provided me with daily support and coping strategies that have dramatically improved my quality of life."
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="py-16 bg-therapeutic-lavender/10">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="max-w-2xl mx-auto mb-8 text-therapeutic-charcoal/70">
              Join thousands of others who have found relief and recovery through ReCognia's innovative approach to PTSD therapy.
            </p>
            <Link to="/register">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="border-t border-white/10 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
            <p className="text-white/70 text-sm">
              &copy; {new Date().getFullYear()} ReCognia. All rights reserved.
            </p>
